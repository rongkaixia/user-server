...
final case class QueryOrderResponse(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.gold.QueryOrderResponse = {
...
object QueryOrderResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[QueryOrderResponse] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[QueryOrderResponse] = this
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.gold.QueryOrderResponse = {
  ...
  implicit class QueryOrderResponseLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, QueryOrderResponse]) extends com.trueaccord.lenses.ObjectLens[UpperPB, QueryOrderResponse](_l) {
