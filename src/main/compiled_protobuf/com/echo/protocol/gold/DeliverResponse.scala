...
final case class DeliverResponse(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.gold.DeliverResponse = {
...
object DeliverResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[DeliverResponse] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[DeliverResponse] = this
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.gold.DeliverResponse = {
  ...
  implicit class DeliverResponseLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, DeliverResponse]) extends com.trueaccord.lenses.ObjectLens[UpperPB, DeliverResponse](_l) {
