...
final case class QueryOrderRequest(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.gold.QueryOrderRequest = {
...
object QueryOrderRequest extends com.trueaccord.scalapb.GeneratedMessageCompanion[QueryOrderRequest] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.gold.QueryOrderRequest = {
