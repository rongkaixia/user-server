...
/** @param items
  ...
  * @param payAmt
  *   应支付价格 = sum(items.total)
  * @param realPayAmt
  *   实际支付价格 = sum(items.total) + discount
  * @param state
  *   订单状态
  * @param createAt
  *   创建时间
...
final case class OrderInfo(
    ...
    def addItems(__vs: com.echo.protocol.product.ItemInfo*): OrderInfo = addAllItems(__vs)
    def addAllItems(__vs: TraversableOnce[com.echo.protocol.product.ItemInfo]): OrderInfo = copy(items = items ++ __vs)
    def withItems(__v: scala.collection.Seq[com.echo.protocol.product.ItemInfo]): OrderInfo = copy(items = __v)
...
object OrderInfo extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.gold.OrderInfo] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.gold.OrderInfo = {
    ...
    com.echo.protocol.gold.OrderInfo(
      ...
      __fieldsMap.getOrElse(__fields.get(2), Nil).asInstanceOf[scala.collection.Seq[com.echo.protocol.product.ItemInfo]],
  ...
  def messageCompanionForField(__field: com.google.protobuf.Descriptors.FieldDescriptor): com.trueaccord.scalapb.GeneratedMessageCompanion[_] = {
    ...
    __field.getNumber match {
      case 3 => __out = com.echo.protocol.product.ItemInfo
    }
  __out
  }
