...
@SerialVersionUID(0L)
final case class NotifyResponse(
    ...
    def clearHeader: NotifyResponse = copy(header = None)
    def withHeader(__v: com.echo.protocol.common.ResponseHeader): NotifyResponse = copy(header = Some(__v))
