...
final case class AddUserAddressRequest(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.AddUserAddressRequest = {
...
object AddUserAddressRequest extends com.trueaccord.scalapb.GeneratedMessageCompanion[AddUserAddressRequest] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.AddUserAddressRequest = {
