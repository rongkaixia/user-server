...
final case class UpdateUserInfoResponse(
    ...
    def mergeFrom(`_input__`: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.UpdateUserInfoResponse = {
      ...
      com.echo.protocol.captain.UpdateUserInfoResponse(
          header = __header
      )
    }
    ...
    def clearHeader: UpdateUserInfoResponse = copy(header = None)
    def withHeader(__v: com.echo.protocol.common.ResponseHeader): UpdateUserInfoResponse = copy(header = Some(__v))
    ...
    def companion = com.echo.protocol.captain.UpdateUserInfoResponse
}

object UpdateUserInfoResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.captain.UpdateUserInfoResponse] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.captain.UpdateUserInfoResponse] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.UpdateUserInfoResponse = {
  ...
  lazy val defaultInstance = com.echo.protocol.captain.UpdateUserInfoResponse(
  )
  implicit class UpdateUserInfoResponseLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, com.echo.protocol.captain.UpdateUserInfoResponse]) extends com.trueaccord.lenses.ObjectLens[UpperPB, com.echo.protocol.captain.UpdateUserInfoResponse](_l) {
