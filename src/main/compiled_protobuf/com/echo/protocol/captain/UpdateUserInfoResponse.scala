...
final case class UpdateUserInfoResponse(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.UpdateUserInfoResponse = {
...
object UpdateUserInfoResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[UpdateUserInfoResponse] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.UpdateUserInfoResponse = {
