...
final case class UserAddress(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.UserAddress = {
...
object UserAddress extends com.trueaccord.scalapb.GeneratedMessageCompanion[UserAddress] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.UserAddress = {
