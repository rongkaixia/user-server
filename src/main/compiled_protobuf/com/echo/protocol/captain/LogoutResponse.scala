...
final case class LogoutResponse(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.LogoutResponse = {
...
object LogoutResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[LogoutResponse] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.LogoutResponse = {
