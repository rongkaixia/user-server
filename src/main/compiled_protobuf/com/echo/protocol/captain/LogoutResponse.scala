...
final case class LogoutResponse(
    ...
    def mergeFrom(`_input__`: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.LogoutResponse = {
      ...
      com.echo.protocol.captain.LogoutResponse(
          header = __header
      )
    }
    ...
    def clearHeader: LogoutResponse = copy(header = None)
    def withHeader(__v: com.echo.protocol.common.ResponseHeader): LogoutResponse = copy(header = Some(__v))
    ...
    def companion = com.echo.protocol.captain.LogoutResponse
}

object LogoutResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.captain.LogoutResponse] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.captain.LogoutResponse] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.LogoutResponse = {
  ...
  lazy val defaultInstance = com.echo.protocol.captain.LogoutResponse(
  )
  implicit class LogoutResponseLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, com.echo.protocol.captain.LogoutResponse]) extends com.trueaccord.lenses.ObjectLens[UpperPB, com.echo.protocol.captain.LogoutResponse](_l) {
