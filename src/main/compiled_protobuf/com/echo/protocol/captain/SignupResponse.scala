...
final case class SignupResponse(
    ...
    def mergeFrom(__input: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.SignupResponse = {
...
object SignupResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[SignupResponse] {
  ...
  def fromFieldsMap(__fieldsMap: Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.SignupResponse = {
  ...
  def descriptor: com.google.protobuf.Descriptors.Descriptor = CaptainProto.descriptor.getMessageTypes.get(12)
