...
final case class QueryUserInfoResponse(
    ...
    private[this] def __computeSerializedValue(): Int = {
      ...
      if (userInfo.isDefined) { __size += 1 + com.google.protobuf.CodedOutputStream.computeUInt32SizeNoTag(userInfo.get.serializedSize) + userInfo.get.serializedSize }
      __size
    }
    ...
    def mergeFrom(`_input__`: com.google.protobuf.CodedInputStream): com.echo.protocol.captain.QueryUserInfoResponse = {
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __userInfo = Some(com.trueaccord.scalapb.LiteParser.readMessage(_input__, __userInfo.getOrElse(com.echo.protocol.captain.UserInfo.defaultInstance)))
...
object QueryUserInfoResponse extends com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.captain.QueryUserInfoResponse] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[com.echo.protocol.captain.QueryUserInfoResponse] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.echo.protocol.captain.QueryUserInfoResponse = {
  ...
  def descriptor: com.google.protobuf.Descriptors.Descriptor = CaptainProto.descriptor.getMessageTypes.get(19)
  ...
  implicit class QueryUserInfoResponseLens[UpperPB](_l: com.trueaccord.lenses.Lens[UpperPB, com.echo.protocol.captain.QueryUserInfoResponse]) extends com.trueaccord.lenses.ObjectLens[UpperPB, com.echo.protocol.captain.QueryUserInfoResponse](_l) {
